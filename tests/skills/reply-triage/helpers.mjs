// tests/skills/reply-triage/helpers.mjs — test helpers.
// (Kept inside tests/skills/reply-triage/ rather than the shared tests/helpers/.)
...
export const SKILL = 'reply-triage';
...
export function tmpRoot (prefix = 'reply-triage-') {
...
export function validatorSandbox (skillNames) {
  const dir = tmpRoot('reply-triage-validate-');
