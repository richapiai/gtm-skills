// tests/skills/account-research/helpers.mjs — test helpers.
// (Kept inside tests/skills/account-research/ rather than the shared tests/helpers/.)
...
export const SKILL = 'account-research';
 ...
 * `###` subsections stay inside their parent, which is what the tier tests want —
 * the profile_activities warning is a `###` inside Pass 3 and belongs to Pass 3.
 */
...
export function tmpRoot (prefix = 'account-research-') {
 ...
 * this suite red over another skill's routing. Observed live on 2026-08-28 —
 * tests/skills/tam-map/skill-shape.test.mjs copies `icp-review` but not the
 * `gtm-kickoff` and `comply` it links to, and fails while the real tree is green.
 */
...
export function validatorSandbox (skillNames) {
  const dir = tmpRoot('account-research-validate-');
